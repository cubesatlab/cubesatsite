<%-- 
    Document   : AlaskanIce-Software.jsp
...
<html lang="en">
  ...
  <div id="page">
    <div class="post">
      <h1 class="ada_compliance">Software Components</h1> <p><img src="images/software.png" alt="Software
      ...
      compiler available. In order to combat this, a software toolchain has been created, which
      can be seen at right. </p>
      ...
      <b><a href="http://www.sofcheck.com/">SofCheck</a></b>'s AdaMagic compiler, which compiles the
      Ada code into C code. That C code is then combined with microcontroller device drivers
