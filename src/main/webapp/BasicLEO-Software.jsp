<%-- 
    Document   : BasicLEO-Software.jsp
...
<html lang="en">
  ...
  <div id="page">
    ...
    <div class="post">
      ...
      <p>Our software makes no use of an operating system but instead runs on the bare metal.
      ...
      <p><img src="images/software.png" alt="Software Toolchain Diagram" style="float: right; border: 0;margin-left:20px;"/></p>

      <p>We used the <b><a
      href="http://www.ti.com/lsds/ti/microcontrollers_16-bit_32-bit/msp/ultra-low_power/overview.page">Texas
      Instruments MSP430</a></b> microcontroller due to its exceptionally low power consumption and
      our prior experience with it in the <b><a href="/cubesat/AlaskanIce.jsp">Alaskan
      Ice Buoy project</a></b>. Unfortunately when we started our project there was no Ada compiler
      available for the MSP430. Thus we used a tool chain, shown at right, that converted the
      SPARK to C using <b><a href="http://www.sofcheck.com/">SofCheck</a></b>'s AdaMagic compiler. We
      then compiled the C, along with the required low level drivers and libraries, to MSP430
      object code using <b><a href="http://www.rowley.co.uk/">Rowley Associates</a></b>'
      CrossWorks.</p>

      <p>The primary Ada development was done using the GPS integrated development environment
      from <b><a href="http://www.adacore.com/">AdaCore</a></b>. GPS supports integration with SPARK
      and the GNAT Ada compiler was used for compiling and running tests. AdaMagic was only used
      to generate the final flight software via CrossWorks as described above.</p>
    </div>
    ...
    <div class="post">
      ...
      tool, or via focused testing.</p>

      <p>The C portion of the flight control program consists of 2239 line (<em>including</em>
