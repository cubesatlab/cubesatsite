<%-- 
    Document   : BasicLEO-Hardware.jsp
  ...
  <div id="page">
    <div class="post">
      ...
      <ul>
        ...
        <p><a class="imageLink" href="images/ClydeSpaceEPS.jpg"><img src="images/ClydeSpaceEPS.jpg" alt="Clyde Space EPS" width="200"/></a></p></li>
        ...
        <p><a class="imageLink" href="images/AstrodevHelium-100.jpg"><img src="images/AstrodevHelium-100.jpg" alt="Astrodev Helium-100" width="200"/></a></p></li>

        <li><p><strong><a href="http://www.isispace.nl">ISIS</a> AntS Deployable
        Antenna</strong></p>

        <p>Crossed dipole antennas for 2m and 70cm, deploy after the CubeSat is deployed from
        the launch vehicle.</p>

        <p><a class="imageLink" href="images/ISIS-AntS.jpg"><img src="images/ISIS-AntS.jpg" alt="ISIS AntS" width="200"/></a></p></li>
        ...
        <p><a class="imageLink" href="images/NovatelOEMV-1.jpg"><img src="images/NovatelOEMV-1.jpg" alt="Novatel
        OEMV-1 GPS" width="200"/></a></p></li>

        <li><p><strong>IMU/Camera/Patch Antenna/Hysteresis Board</strong></p>

        <p>Mounts our <b><a href="http://www.microstrain.com">Microstrain</a></b> Inertial Measurement
        Unit, our GPS patch antenna, our camera and hysteresis rods.</p>

        <p><a class="imageLink" href="images/IMU-board.jpg"><img src="images/IMU-board.jpg" alt="IMU/Camera/GPS
        ...
        <p><a class="imageLink" href="images/DSC08890cropped.JPG"><img src="images/DSC08890cropped.JPG"
        width="200" alt="Photovoltaics Panels"/></a></p></li>
      </ul>

      <!-- BEGIN FOOTER -->
      <div id="footer">
        <p>&#169; Copyright 2019 by Vermont Technical College | Last Revised: December 21, 2019</p>
      </div>
      <!-- END FOOTER -->
    </div>
  </div>
